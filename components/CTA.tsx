  ...
  return (
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <a href="/contact" className="bg-sapient-teal text-white px-12 py-5 rounded-full font-bold text-lg shadow-xl shadow-sapient-teal/30 hover:shadow-2xl hover:shadow-sapient-teal/40 hover:-translate-y-1 hover:bg-sapient-teal-dark transition-all duration-300 tracking-wide block w-max mx-auto">
          Submit a Query
        </a>
      </div>
    </section>
