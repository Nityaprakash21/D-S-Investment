        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-sapient-teal to-sapient-teal-dark rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg border border-white/10">
                D&S
              </div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-6 text-gray-400 text-sm font-light">
              <li className="flex items-start gap-4 group">
                ...
                <span>123 Financial District,<br />Business Bay, Mumbai - 400001</span>
              </li>
