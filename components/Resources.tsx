      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end text-center md:text-left mb-16 border-b border-gray-200 pb-6">
          <div>
            ...
            <h2 className="text-4xl font-serif text-sapient-slate max-w-xl leading-tight whitespace-nowrap md:whitespace-nowrap whitespace-normal">
              <span className="block md:inline">Insights that shape</span>
              <span className="block md:inline"> better decisions.</span>
            </h2>
          </div>
        </div>
